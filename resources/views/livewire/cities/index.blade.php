    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
            <div class="col-md-12 user_status">
                ...
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-city">
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                        <div
                            ...
                            <div class="dt-buttons btn-group flex-wrap"><a class="btn add-new btn-primary mt-50"
                                    tabindex="0"
                                    href="{{ route('cities.create') }}"><span>{{ __('Add New City') }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <table class="city-list-table table dataTable no-footer dtr-column" id="DataTables_Table_0"
                    city="grid" aria-describedby="DataTables_Table_0_info">
                    <thead class="table-light">
                        <tr city="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                ...
                                aria-label="City: activate to sort column ascending">{{ __('City AR') }}</th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="width: 120.25px;"
                                aria-label="City: activate to sort column ascending">{{ __('City EN') }}</th>

                            @if (authorized('Edit city') || authorized('Delete city'))
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                @if (authorized('Edit city'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('cities.edit', Crypt::encrypt($city->id)) }}">
                                                ...
                                                @if (authorized('Delete city'))
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        wire:click="saveAdminWillDeleted('{{ Crypt::encrypt($city->id) }}')"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel120">{{ __('Delete City') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        {{ __('After you delete this city, system can keep his information for 30 days only. You can back them up before end this time.') }}
                    </div>
