    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
            <div class="col-md-12 user_status">
                ...
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-place">
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-6 ps-xl-75 ps-0">
                        <div
                            ...
                            <div class="dt-buttons btn-group flex-wrap"><a class="btn add-new btn-primary mt-50"
                                    tabindex="0"
                                    href="{{ route('places.create') }}"><span>{{ __('Add New Place') }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <table class="place-list-table table dataTable no-footer dtr-column" id="DataTables_Table_0"
                    place="grid" aria-describedby="DataTables_Table_0_info">
                    <thead class="table-light">
                        <tr place="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                ...
                                aria-label="Place: activate to sort column ascending">{{ __('Place AR') }}</th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="width: 120.25px;"
                                aria-label="Place: activate to sort column ascending">{{ __('Place EN') }}</th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="width: 120.25px;"
                                aria-label="Place: activate to sort column ascending">{{ __('City') }}</th>
                            @if (authorized('Edit place') || authorized('Delete place'))
                    ...
                    <tbody>
                        ...
                        @foreach ($places as $place)
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ route('cities.edit', Crypt::encrypt($place->city()->first()?->id)) }}">{{ app()->getLocale() == 'ar' ? $place->city()->first()?->name_ar : $place->city()->first()?->name_en }}</a>
                                </td>
                                @if (authorized('Edit place') || authorized('Delete place'))
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                @if (authorized('Edit place'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('places.edit', Crypt::encrypt($place->id)) }}">
                                                ...
                                                @if (authorized('Delete place'))
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        wire:click="saveAdminWillDeleted('{{ Crypt::encrypt($place->id) }}')"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel120">{{ __('Delete Place') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        {{ __('After you delete this place, system can keep his information for 30 days only. You can back them up before end this time.') }}
                    </div>
